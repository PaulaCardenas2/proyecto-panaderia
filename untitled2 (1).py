...
st.set_page_config(page_title="Calculadora Panadería Artesanal 🍞📊", layout="centered")

# Título de la app
st.title("Calculadora de Punto de Equilibrio 🧮🍞")
st.markdown("Esta aplicación te ayudará a conocer cuándo tu panadería artesanal comienza a generar ganancias 💰✨.")
...
if precio_venta <= costo_variable:
    st.error("⚠️ El precio de venta debe ser mayor al costo variable para que haya ganancia.")
else:
    # Cálculo del punto de equilibrio
    punto_equilibrio = costo_fijo / (precio_venta - costo_variable)
    punto_equilibrio = round(punto_equilibrio)

    st.success(f"📈 Tu panadería artesanal debe vender al menos **{punto_equilibrio} panes** al mes para alcanzar el punto de equilibrio.")
    ...
    # Mostrar gráfico 📊
    st.subheader("Gráfico de Ingresos vs Costos Totales 📉📈")
    fig, ax = plt.subplots()
